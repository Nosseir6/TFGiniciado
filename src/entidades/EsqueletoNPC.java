...
/**
 * La clase EsqueletoNPC representa un NPC (Non-Player Character) enemigo del tipo esqueleto en el juego.
 * Hereda de la clase Entidad y define comportamientos específicos para el esqueleto NPC.
 */
public class EsqueletoNPC extends Entidad {

    /**
     * Constructor para la clase EsqueletoNPC.
     * @param pJuego La referencia al objeto PanelJuego que contiene la configuración del juego.
     */
    public EsqueletoNPC(PanelJuego pJuego) {
        super(pJuego);
    ...
    /**
     * Carga las imágenes de los diferentes sprites para las animaciones del esqueleto NPC.
     */
    ...
    /**
     * Establece la acción del esqueleto NPC de manera aleatoria cada cierto tiempo.
